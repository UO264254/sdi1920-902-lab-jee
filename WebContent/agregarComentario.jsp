...
<body>
	...
	<jsp:useBean id="comentario" class="com.uniovi.sdi.blog.Comentario" />
	<jsp:setProperty name="comentario" property="*" />
	
	<c:if test="${comentario.mensaje != null}">
	...
	<div class="container" id="contenedor-principal">
		...
		<form class="form-horizontal" method="post" action="agregarComentario.jsp">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text"  name="mensaje" required="true" />
				</div>
			</div>
			<div class="form-group">
